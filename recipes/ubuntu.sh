...
echo -e "\n=> Installing libs needed for sqlite and mysql and postgresql..."
sudo $pm -y install libsqlite3-0 sqlite3 libsqlite3-dev libmysqlclient-dev libpg-dev >> $log_file 2>&1
echo "==> done..."
...
# Install nodejs
echo -e "\n=> Installing nodejs as js runtime..."
